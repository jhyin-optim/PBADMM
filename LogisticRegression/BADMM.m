...
%% Apply BADMM to solve the so-called empirical $\ell_1$-logistic 
...
% (including the value of the objective function and the gradient at |x|)£¬
% parameters |opts| ¡£
%
% output imformation£ºthe resulting solution |x| and other iterative imformation |out|
%
% * |out.msg| £ºmark whether the algorithm converges
% * |out.nrmG| £ºthe gradient norm at exit
% * |out.iter| £ºthe number of iterations at exit
% * |out.f| £ºthe value of the objective function at exit
% * |out.nfe| £ºthe number of calling the function values
